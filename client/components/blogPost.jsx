...
class BlogPost extends Component {
    render() {
        ...
        return (
            ...
            >
                <img src={blogpost.img_src} alt={""} />
                <div className={"l-small-padding-left l-detailed-info-column"}>
                    <h1>{blogpost.title}</h1>
                    <p>
                        Some interesting text snipped of this article I like or
                        wrote
                    </p>
                ...
                <div className={"l-detailed-info-column"}>
                    <p>
                        This is a short description of the article or post that
                        I just linked. It should provide the thesis and a tiny
                        bit of true clickbait. I'll probably want to fetch this
                        stuff from the db eventually
                    </p>
