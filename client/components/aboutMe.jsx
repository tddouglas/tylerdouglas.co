    ...
    render() {
        return (
            <div className={"c-about-me"}>
                ...
                />
                <div
                    className={"c-info l-small-padding-top l-small-margin-top"}
                >
                    <h2>Hi, I'm Tyler. Welcome to my website.</h2>
                    <p
                        className={
                            "l-small-padding-top l-left-margin l-right-margin"
                        }
                    >
                        Hello This is some text about myself and what I like to
                        do. Thanks for visiting bla bla blah. I build stuff for
                        things and am interested in stuff so this is really nice
                        for me to have you on my site.
                    </p>
                </div>
                <div
                    className={
                ...
                >
                    ...
                    <div className={"l-detailed-info-column c-border-left"}>
                        Column 3
                    </div>
                </div>
