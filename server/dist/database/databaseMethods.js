    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, database_js_1["default"].query("SELECT * FROM users WHERE id = $1", [
                            1
                        ])];
                case 1:
                    rows = (_a.sent()).rows;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, database_js_1["default"].query("INSERT INTO users (name, email) VALUES ($1, $2) RETURNING *", [name, email])];
                case 1:
                    rows = (_a.sent()).rows;
